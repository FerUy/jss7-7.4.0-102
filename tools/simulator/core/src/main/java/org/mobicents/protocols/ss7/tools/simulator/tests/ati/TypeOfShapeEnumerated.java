...
public class TypeOfShapeEnumerated extends EnumeratedBase {
  ...
  public static org.mobicents.protocols.ss7.tools.simulator.tests.psi.TypeOfShapeEnumerated createInstance(String s) {
    Integer instance = doCreateInstance(s, stringMap, intMap);
    if (instance == null)
      return new org.mobicents.protocols.ss7.tools.simulator.tests.psi.TypeOfShapeEnumerated(TypeOfShape.EllipsoidPoint.getCode());
    else
      return new org.mobicents.protocols.ss7.tools.simulator.tests.psi.TypeOfShapeEnumerated(instance);
  }

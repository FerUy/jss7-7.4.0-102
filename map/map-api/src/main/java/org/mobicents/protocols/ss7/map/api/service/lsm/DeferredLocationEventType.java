...
/**
 * DeferredLocationEventType ::= BIT STRING { msAvailable (0) , enteringIntoArea (1), leavingFromArea (2), beingInsideArea (3), periodicLDR (4) }
 * (SIZE (1..16))
 ...
 * -- exception handling:
 * -- a ProvideSubscriberLocation-Arg containing other values than listed above in DeferredLocationEventType shall be rejected by the receiver

...
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsClientStandardManMBean;
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsClientManMBean;
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsServerStandardManMBean;
...
import org.mobicents.protocols.ss7.tools.simulator.tests.psi.TestPsiServerStandardManMBean;
...
//    }
    ...
    public void start(String appName, int httpPort, int rmiPort, int rmiPort2) throws MalformedObjectNameException,
        ...
        ObjectName nameLcsClientManMan = new ObjectName("SS7_Simulator_" + appName + ":type=TestLcsClientMan");
        ...
        try {
            ...
            TestLcsClientStandardManMBean mapLcsClientManMBean = new TestLcsClientStandardManMBean(host.getTestLcsClientMan(), TestLcsClientManMBean.class);
            mbs.registerMBean(mapLcsClientManMBean, nameLcsClientManMan);

            TestLcsServerStandardManMBean mapLcsServerManMBean = new TestLcsServerStandardManMBean(host.getTestLcsServerMan(), TestLcsServerManMBean.class);
        ...
        mbs.unregisterMBean(nameLcsClientManMan);

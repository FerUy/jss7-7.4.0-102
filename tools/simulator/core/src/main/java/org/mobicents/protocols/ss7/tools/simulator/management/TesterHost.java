...
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsClientConfigurationData;
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsServerConfigurationData;
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsClientMan;
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsServerMan;
import org.mobicents.protocols.ss7.tools.simulator.tests.psi.TestPsiServerConfigurationData;
import org.mobicents.protocols.ss7.tools.simulator.tests.psi.TestPsiServerMan;
    ...
    public void start() {
        ...
        switch (this.configurationData.getInstance_TestTask().intValue()) {
            ...
            case Instance_TestTask.VAL_PSI_TEST_SERVER:
                if (curMap == null) {
                  this.sendNotif(TesterHost.SOURCE_NAME, "Error initializing MAP_PSI_TEST_SERVER: No MAP stack is defined at L3",
                  "", Level.WARN);
                } else {
            ...
            default:
              ...
              this.sendNotif(TesterHost.SOURCE_NAME, "Instance_TestTask."
                      + this.configurationData.getInstance_TestTask().toString() + " has not been implemented yet", "", Level.WARN);
              break;
        }
        if (!started) {
...
//    }
    ...
    private boolean loadOld(File fn) {
        ...
        try {
            ...
            // FIXME mnowa: add loading of CheckIMEI data from XML for server

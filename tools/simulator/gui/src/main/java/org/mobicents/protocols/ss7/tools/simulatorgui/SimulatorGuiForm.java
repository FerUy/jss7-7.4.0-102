...
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsClientManMBean;
import org.mobicents.protocols.ss7.tools.simulator.tests.lcs.TestLcsServerManMBean;
...
import org.mobicents.protocols.ss7.tools.simulatorgui.tests.lcs.TestLcsClientForm;
import org.mobicents.protocols.ss7.tools.simulatorgui.tests.lcs.TestLcsServerParamForm;
import org.mobicents.protocols.ss7.tools.simulatorgui.tests.lcs.TestLcsServerForm;
import org.mobicents.protocols.ss7.tools.simulatorgui.tests.lcs.TestLcsClientParamForm;
import org.mobicents.protocols.ss7.tools.simulatorgui.tests.psi.TestPsiServerForm;
import org.mobicents.protocols.ss7.tools.simulatorgui.tests.psi.TestPsiServerParamForm;
...
public class SimulatorGuiForm extends JFrame implements NotificationListener {
            ...
            public void actionPerformed(ActionEvent e) {
                switch (((Instance_TestTask) cbTestTask.getSelectedItem()).intValue()) {
                    ...
                    case Instance_TestTask.VAL_MAP_LCS_TEST_SERVER: {
                        TestLcsServerParamForm frame = new TestLcsServerParamForm(getJFrame());
                        frame.setData(lcsServer);
                        frame.setVisible(true);
                    }
                    break;
                    case Instance_TestTask.VAL_MAP_LCS_TEST_CLIENT: {
                        TestLcsClientParamForm frame = new TestLcsClientParamForm(getJFrame());
                        frame.setData(lcsClient);
                        frame.setVisible(true);
                    }
                    break;
    ...
    private void openTest() {
        ...
        switch (((Instance_TestTask) cbTestTask.getSelectedItem()).intValue()) {
            ...
            break;
            case Instance_TestTask.VAL_MAP_LCS_TEST_SERVER: {
                TestLcsServerForm testLcsServerForm = new TestLcsServerForm(getJFrame());
                testLcsServerForm.setData(lcsServer);
                dlg = testLcsServerForm;
            }
            break;
            case Instance_TestTask.VAL_MAP_LCS_TEST_CLIENT: {
                TestLcsClientForm testLcsClientForm = new TestLcsClientForm(getJFrame());
                testLcsClientForm.setData(lcsClient);
    ...
    protected void startHost(String appName, boolean isRemote, final TesterHost hostImpl, TesterHostMBean host, M3uaManMBean m3ua, DialogicManMBean dialogic,
                             ...
                             TestCheckImeiServerManMBean checkImeiServer, TestLcsClientManMBean lcsClient, TestLcsServerManMBean lcsServer, TestPsiServerManMBean psiServer) {
